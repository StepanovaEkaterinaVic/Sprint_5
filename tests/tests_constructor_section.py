...
def test_navigate_to_sauces_section(driver): # переход к разделу "Соусы"
...
def test_navigate_to_fillings_section(driver): # переход к разделу "Начинки"
...
def test_navigate_to_bread_section(driver): # переход к разделу "Булки"
    driver.find_element(*Locators.FILLING_SECTION).click()
